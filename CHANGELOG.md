...
This promotes [v3.7.0-RC3](../../releases/tag/v3.7.0-RC3) to final with no changes.
...
- **Dependency**: [on Clojars](https://clojars.org/com.taoensso/nippy/versions/3.7.0-RC3)
- **Versioning**: [Break Versioning](https://www.taoensso.com/break-versioning)
...
# `v3.7.0-RC2` (2026-06-02)

- **Dependency**: [on Clojars](https://clojars.org/com.taoensso/nippy/versions/3.7.0-RC2)
- **Versioning**: [Break Versioning](https://www.taoensso.com/break-versioning)

Fixes a regression in v3.7.0-beta1 and v3.7.0-RC1 that could break users who write primitive numeric arrays AND have disabled Java Serializable support.
...
## Since v3.7.0-RC1 (2026-06-02)

- [fix] Restore native (non-Serializable) writing of primitive numeric arrays \[800f95b]
- [new] Initial (read) support for more robust deftype serialization \[b5d803f]
